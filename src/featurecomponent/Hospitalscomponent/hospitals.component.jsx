...
export function Hosptial() {
  return (
    <div>
      ...
      <div>
        <h2 className='top-hospital-main-heading'>Top Hospitals in Dubai</h2>
      </div>
      <div className="containerr">
        ...
        <div className="text">
          <h1 className='roy-head1'>Dubai Hospital Royalty.</h1>
      ...
      <div className="containerr">
        <div >
          <img className="image-1" src={hoszuleka} width="300px" height="200px" alt="Dubai" />
        </div>
        <div className="text">
          <h1>Zulekha Hospital.</h1>
          <p style={{ cursor: 'pointer' }}>
            <b>Trust</b> <a href="#">Verified</a> <button className='top-search' style={{ cursor: 'pointer' }}>Top Search</button>
          </p>
